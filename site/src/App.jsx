        ...
        <div className="relative flex flex-row overflow-hidden">
            <div className="relative">
                <button
                    ...
                    className={` absolute cursor-pointer z-1 ${lPanelState === "open" ? "right-1.5" : "-right-6"} scale-80 top-0 bg-black hover:scale-110 transition-all ease-in active:scale-95`}
                    onClick={() => {
                        lPanelState === "open"
