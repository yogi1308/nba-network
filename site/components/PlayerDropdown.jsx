...
export default function PlayerDropdown() {
    ...
    // player's name, or "All Players" if nothing is chosen.
    const displayText =
        ALL_PLAYERS.find((p) => p.key === selectedKey)?.label ?? ALL_OPTION.label;
    ...
    const options = useMemo(() => {
        ...
        const matches = q
            ...
            : ALL_PLAYERS;
        // Only offer "All Players" when the query can't rule it out.
        const allMatches = !q || ALL_OPTION.label.toLowerCase().includes(q);
